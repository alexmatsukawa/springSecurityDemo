...
public class ApplicationSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                //Below code is deprecated upon changes made to use JWT. This code block can be added back under line 49
                //('.authenticated()') if you decide to forgo JWT
//                .and()
//                .formLogin()
//                    .loginPage("/login")
//                    .permitAll()
...
//                .antMatchers(HttpMethod.GET, "/management/api/**").hasAnyRole(ADMIN.name(), ADMINTRAINEE.name())
     ...
     * This code block was used to hard code the user's details through the User Details class; code was updated to use
     * DaoAuthentication instead.
    @Override
    @Bean
